# <div align='center'>Manul-Ofc-Baileys-New - Typescript/Javascript WhatsApp Web API</div>

<div align="center"><img src="https://i.ibb.co/XZFdhy0/IMG-20250102-WA0065.jpg"></div>
...
```json
"dependencies": {
    "baileys": "npm:manul-ofc-baileys-new"
}
```
or install in terminal:
```
npm install baileys@npm:manul-ofc-baileys-new
```
...
## Reporting Issues
If you encounter any issues while using this repository or any part of it, please feel free to open a [new issue](https://wa.me/94742274855?text=*Hey_Issue_Found*) here.
